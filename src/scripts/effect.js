...
$('document').ready(function(){
	...
	$('#invite_friends').click(function(){
		...
		$('#f1').animate({top:mid-mid_diff*3,left:vw-vw_diff*2},3000);


		$('#f2').css({"display": "block", "top":500*Math.random()+'px',"left":'0px'});
		$('#f2').animate({top:mid-mid_diff*3,left:vw+vw_diff*2},3000);
		...
		$('#f7').animate({top:mid,left:vw-vw_diff*8},3000);


		$('#f8').css({"display": "block", "top":500*Math.random()+'px',"right":'0px'});
		$('#f8').animate({top:mid,left:vw+vw_diff*8},3000);


		$('#f9').css({"display": "block", "top":500*Math.random()+'px',"left":'0px'});
		$('#f9').animate({top:mid+mid_diff*3,left:vw+vw_diff*4},3000);

		$('#f10').css({"display": "block", "top":500*Math.random()+'px',"right":'0px'});
		$('#f10').animate({top:mid+mid_diff,left:vw-vw_diff*10},3000);


		$('#f11').css({"display": "block", "top":500*Math.random()+'px',"right":'0px'});
		$('#f11').animate({top:mid+mid_diff,left:vw+vw_diff*10},3000);
